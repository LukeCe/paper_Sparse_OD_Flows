...
our article *“Efficient Estimation of Spatial Econometric Interaction
Models for Sparse OD Matrices”*, currently available as a working paper:

> Dargel, Lukas, and Christine Thomas-Agnan (2023). *Efficient
> Estimation of Spatial Econometric Interaction Models for Sparse OD
> Matrices*. TSE Working Paper, n. 23-1456, July 2023., Accessed 08 Nov
> 2023. Online at
> <https://www.tse-fr.eu/sites/default/files/TSE/documents/doc/wp/2023/wp_tse_1456.pdf>

The article develops new calculation tools to efficiently estimate the
gravity models that account for spatial dependence in OD flows. A
vignette accompanying the article presents the analysis of national
level home-to-work commuting flows between the c.a. 35000 municipalities
of metropolitan France and can be [downloaded directly as
HTML](https://htmlpreview.github.io/?https://github.com/LukeCe/paper_Sparse_OD_Flows/blob/master/notebooks/%%%.html).

## Notes on reproducibility

To reproduce all results of the article and the vignette, you can run
